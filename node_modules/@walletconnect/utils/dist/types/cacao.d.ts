...
export declare const getDidAddressNamespace: (iss: string) => string | undefined;
...
export declare function createRecap(resource: string, ability: string, actions: string[], limits?: {}): RecapType;
type RecapType = {
    att: {
