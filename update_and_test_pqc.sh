...
echo "=== 1. Rewriting HempOffGridDAO.sol with Hybrid PQC & RoomieBot Integration ==="
...
echo "=== 2. Rewriting Test Suite (HempOffGridDAO.t.sol) with PQC & Bot Rotation Tests ==="
